...
function PressChart () {
    ...
    return (
        <LineChart width={530} height={300} data={cities}>
                    ...
                    <YAxis dataKey={"pressure_mb"} domain={[800, 1200]} type="number" style={{fontSize: '0.6rem'}}/>
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="pressure_mb" stroke="#8884d8" strokeWidth={3} isAnimationActive={false}/>
        </LineChart>
    );
}
